...
const projectName = ['new test project4'];
...
async function testCreateProject(){
  ...
  chromeOptions.set('chromeOptions', caps);
    ...
    try{
        ...
        // NOTE: This is the actual solution. TODO: Make it work
        // await driver.wait(until.stalenessOf(By.xpath('//div[text() = "Create Org"]')) , 10000);
        const createProjectButton = await driver.findElements(By.css('button'));
        await createProjectButton[1].click();
        await driver.wait(until.elementLocated(By.css('label')), 10000);
